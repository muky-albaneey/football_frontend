    ...
    <div className='conShop'>
      ...
      <div className="shoping-cards">
        {selectedData.map((item) => (
          <div key={item.key} id="shoping-card-container">
      ...
      <div className="dropDown">
        <div className="rightShopping">
          <button onClick={() => setNav(!nav)} className={nav === true ? `hideBtn normsBtn_second` : `normsBtn normsBtn_second`}>
            ALL DEPARTMENTS {nav === true ? <BiDownArrowAlt /> : <BiUpArrowAlt />}
          </button>
        ...
        <div className="centerShopping">
          <button onClick={() => setNavs(!navs)} className={navs === true ? `hideBtn` : `normsBtn`}>
            New Arrival {navs === true ? <BiDownArrowAlt /> : <BiUpArrowAlt />}
          </button>
